let allproducts=document.getElementById("verticalproducts")
let products=[
    {name:"Vertical AC",image:"./Vertical/1.png",pprice:"1000000"},
    {name:"Vertical AC",image:"./Vertical/2.png",pprice:"1000000"},
];
